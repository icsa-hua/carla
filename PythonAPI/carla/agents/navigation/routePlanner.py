...
class RoutePlanner(object): 
    ...
    def trace_route(self, origin, destination): 
        ...
        logging.info(f"DESTINATION : {self.dest_wp} and ORIGIN : {self.cur_wp} and destination location : {self.destination}")
    ...
    def optimal_route(self):
        ...
        if not P: 
            warnings.warn("No optimal route has been found")
            return None
    ...
    def _path_search_HGA(self, origin,destination):
        ...
        try : 
            ...
            if self.verbose:
                logging.debug("Best paths based on HGA are ===> ", route)
            return route 
    ...
    def _path_search_Astar(self,origin,destination):
        ...
        try : 
            ...
            if self.verbose:
                logging.debug("Best paths based on A* are ===> ", route)
            return route 
