...
from agents.navigation.dummy_application.application.GraphicalInterface import WaypointInterface
...
class Application():
    ...
    def get_arguments(self): 
        try : 
            logging.info("Getting the arguments")
            ...
            logging.info("All clients have been cleared")
    ...
    def set_vehicle(self,model):
        ...
        logging.info("Vehicle instantiated at {}".format(sp))
    ...
    def run_app_from_topology(self): 
        ...
        logging.info("Saving vehicle information to ego_vehicle.json...")
    ...
    def run_app_from_json(self): 
        ...
        logging.info("Retrieved Information from json file")
    ...
    def set_npc_agents(self): 
        ...
        logging.info("Spawnning NPCs...")


    def run_app(self, agent):
       while True : 
            if agent.done(): 
               logging.info("Agent has reached the destination...")
               logging.info("Program will now exit...")
               break 
